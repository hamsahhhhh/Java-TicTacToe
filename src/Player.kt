            ...
            if (type === "AI") {
                ...
                while (turn) {
                    ...
                    if (valid_input(TicTacToe.user_input)) {
                        ...
                        TicTacToe.user_input =
                            TicTacToe.getInput("That's not valid input.  Please choose another spot: ")
                    }
                }
            }
        }
        ...
        companion object {
            ...
            private fun valid_input(user_input: String): Boolean {
                ...
                if (user_input.length == 2) {
                    output =
                        user_input.substring(0, 1).matches("[0-9]") && user_input.substring(1, 2).matches("[a-zA-Z]")
                } else if (user_input.length == 3) {
                    output = user_input.substring(0, 2).matches("[1-2][0-9]") && user_input.substring(2, 3)
                        .matches("[a-zA-Z]")
